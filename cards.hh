...
class Cards {
    ...
    public:
      ...
      // Note: Usually allowing such access to the inner mechanisms ( through
      // non-const pointer ) of the class is against many programming
      // principles. It is now too, but also required for complete tests.
      ...
      // the caller. Returns false, if the data structure is empty, otherwise
      // returns true.
      bool remove(int& id);
